...
//added code to force refresh of swap chain
bool swapChainRefresh = false;
...
public:
	...
	void forceSwapChainRefresh() {
		swapChainRefresh = true;
	}
...
protected:
	...
	void drawFrame() {
		...
		if (result == VK_ERROR_OUT_OF_DATE_KHR || swapChainRefresh) {
			recreateSwapChain();
			swapChainRefresh = false;
			return;
		}
